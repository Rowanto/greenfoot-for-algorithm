 ...
 * @version 1.0
 */
public class HoldSimulationAction extends AbstractAction
    implements SimulationListener
{
    private static final String iconFile = "hold.png";
    private static HoldSimulationAction instance = new HoldSimulationAction();
    
    /**
     * Singleton factory method for action.
     */
    public static HoldSimulationAction getInstance()
    {
        return instance;
    }
    ...
    private HoldSimulationAction()
    {
        super(Config.getString("hold.simulation"), new ImageIcon(HoldSimulationAction.class.getClassLoader().getResource(iconFile)));
    }
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(simulation == null) {
        	...
        	simulation.fireSimulationEvent(new SimulationEvent(this, SimulationEvent.HOLDED));
        	simulation.setHolded(true);
