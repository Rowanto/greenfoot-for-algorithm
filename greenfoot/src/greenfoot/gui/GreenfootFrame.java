...
import greenfoot.Algorithm;
import greenfoot.Entity;
    ...
    private void populateClassBrowser(ClassBrowser classBrowser, GProject project)
    {
        if (project != null) {
            try {
                ...
                */
                classBrowser.quickAddClass(new ClassView(classBrowser,
                        new GCoreClass(Algorithm.class, project), worldHandlerDelegate));
                classBrowser.quickAddClass(new ClassView(classBrowser,
                        new GCoreClass(Entity.class, project), worldHandlerDelegate));                
