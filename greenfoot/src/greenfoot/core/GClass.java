...
public class GClass
{
    private static String[] simObj = {"greenfoot.Actor", "greenfoot.Algorithm", "greenfoot.Entity"};
    private static String worldObj = "greenfoot.World";
    private static String[] otherSimObj = {"Vertex", "Edge", "Container"};
    private static String[] otherWorldObj = {"SequenceContainer", "Graph"};
    ...
    /**
     * Returns true if this GClass represents the other actor special class defined in otherSimObj
     * 
     */
    public boolean isOtherActorClass()
    {
    	String qualifiedName = getQualifiedName();
    	for (String name : otherSimObj)
    	{
    		if (name.equals(qualifiedName)) 
    		{
    			return true;
    ...
    /**
     * Returns true if this GClass represents the other special world class defined in otherWorldObj
     * 
     */
    public boolean isOtherWorldClass()
    {
    	String qualifiedName = getQualifiedName();
    	for (String name : otherWorldObj)
    	{
    		if (name.equals(qualifiedName)) 
    		{
    			return true;
