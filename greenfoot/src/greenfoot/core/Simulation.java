    ...
    implements WorldListener
{
    ...
    /** Whether the simulation is holded indefinitely */
    private volatile boolean holded;
    
    /** Whether the simulation's hold status is released until the next hold */
    private volatile boolean continueOnce;
	...
	/**
	 * @return the continueOnce status
	 */
	public boolean isContinueOnce() {
		return continueOnce;
	}

	/**
	 * @param continueOnce the continueOnce to set
	 */
	public void setContinueOnce(boolean continueOnce) {
		this.continueOnce = continueOnce;
	}	
