...
public abstract class Actor
{
     ...
     * 
     * <p>The user should not change this.
     */
    public void act()
    {
    	main();
    ...
    /**
     * An equivalent of the act method, the act method will call the main method.
     * 
     * <p>Just think of this as the main method which will be called if the 
     * program is run. Remember to put Greenfoot.hold() at the point where you
     * want to see the actual state of the program
     */
    public void main()
    {
