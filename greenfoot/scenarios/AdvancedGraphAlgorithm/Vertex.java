...
public class Vertex extends Entity {
	...
	public void draw() {
		...
		// Draw the text for the distance
	...
	/**
	 * Get all edges which starts from this vertex
	 * 
	 * @return A list of edges which starts from this vertex
	 */
	public List<Edge> getEdgesFromThisVertex() {
		return getGraph().getEdgesFromVertex(this);
	}

	/**
	 * Get all edges which points to this vertex
	 * 
	 * @return A list of edges which points to this vertex
	 */
	public List<Edge> getEdgesToThisVertex() {
		return getGraph().getEdgesToVertex(this);
	}

	/**
	 * Get the edge from this vertex which points to another vertex
	 * 
	 * @param endVertex The vertex the resulting edge should points to
	 * @return The edge which starts from this vertex and points to endVertex. Returns null if none exists.
	 */
	public Edge getEdgeToThisVertex(Vertex endVertex) {
		return getGraph().getEdgeFromVertexToVertex(this, endVertex);
	}

	/**
	 * Get the edge from another vertex which points to this Vertex
	 * 
	 * @param startVertex The vertex the resulting edge should points from
	 * @return The edge which starts from startVertex and points to this vertex. Returns null if none exists.
	 */
	public Edge getEdgeFromThisVertex(Vertex startVertex) {
		return getGraph().getEdgeFromVertexToVertex(startVertex, this);
	}
