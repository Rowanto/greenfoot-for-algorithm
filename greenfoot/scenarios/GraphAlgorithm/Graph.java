...
public class Graph extends World {
	...
	private void addRandomEdges(int edgeCount) {
		...
		for (Vertex vertex : vertices) {
			...
			if (!checkEdgeExists(startEdge, endEdge)) {
				Edge edge = new Edge(startEdge, endEdge);
				addObject(edge, 0, 0);
			}
		}
		/*
	...
	public void prepareExampleGraph() {
		...
		Edge edge2 = new Edge(vertex, vertex2);
		addObject(edge2, 0, 0);
		...
		Edge edge6 = new Edge(vertex4, vertex6);
		addObject(edge6, 0, 0);
		...
		Edge edge9 = new Edge(vertex6, vertex8);
		addObject(edge9, 0, 0);
	...
	public void prepareDijkstraGraph() {
		...
		Edge edge2 = new Edge(vertex, vertex3);
		...
		Edge edge6 = new Edge(vertex5, vertex4);
		addObject(edge6, 548, 458);

		Edge edge7 = new Edge(vertex4, vertex6);
		addObject(edge7, 471, 505);

		Edge edge8 = new Edge(vertex5, vertex6);
	...
	public void prepareBellmanGraph() {
		...
		Edge edge2 = new Edge(vertex, vertex4);
		addObject(edge2, 457, 500);

		Edge edge3 = new Edge(vertex4, vertex5);
		...
		Edge edge7 = new Edge(vertex5, vertex3);
		addObject(edge7, 493, 483);

		Edge edge8 = new Edge(vertex2, vertex3);
